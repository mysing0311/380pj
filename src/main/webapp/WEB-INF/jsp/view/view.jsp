...
<html>
    ...
    <!--
    <i>Price: $ <c:out value="${item.customerName}" /></i><br /><br />
    <c:out value="${item.price}" /><br /><br />
    
    <i>No. of bids:  <c:out value="${item.customerName}" /></i><br /><br />
    <c:out value="${item.bids}" /><br /><br />
    
    <i>Status: <c:out value="${item.customerName}" /></i><br /><br />
    <c:out value="${item.status}" /><br /><br />
    
    <i>Comments:  <br />
    <c:forEach items="${item.customerName}" var="comment">
